    ...
    <tr>
        <td>
            <center>
                ...
                <button disabled title='You cannot catch another trainers pet.'  type="submit" name="Action" value="Catch"  style="height:100px; width:15%" /><?php echo "Catch <hr> Traps left: " . $UserPet->Get_Item_Count("Pet Trap"); ?></button>
                <button title="Leaves the battle, no exp is gained and you lose 1 AP." type="submit" name="Action" value="Retreat"  style="height:100px; width:20%" />Retreat</button>
            </center>
        </td>
    </tr>
</table>
