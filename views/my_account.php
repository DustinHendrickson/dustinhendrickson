...
switch ($_POST['Mode'])
    {
        case 'Save':
            ...
            $User->Edit_User(Functions::Make_Safe($_POST['First_Name']), Functions::Make_Safe($_POST['Last_Name']), Functions::Make_Safe($User->EMail), Functions::Make_Safe($User->Permissions), Functions::Make_Safe($_POST['Password']));
